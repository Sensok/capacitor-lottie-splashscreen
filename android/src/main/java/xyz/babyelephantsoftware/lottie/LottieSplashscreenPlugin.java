...
public class LottieSplashscreenPlugin extends Plugin {
    ...
    private void configureAnimationView(Context context) {
        ...
        String backgroundColorStr = getUIModeDependentPreference("LottieBackgroundColor", "#000000");
                ...
                new Runnable() {
                    ...
                    public void run() {
                        if (!getActivity().isFinishing()) {
                            ...
                            if (getConfig().getBoolean("LottieEnableMergePaths", false)) animationView.enableMergePathsForKitKatAndAbove(
                                true
                            );
